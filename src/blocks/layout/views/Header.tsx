      ...
      <div className="max-w-4xl mx-auto px-3 sm:px-4 py-2 sm:py-2.5 flex items-center justify-between gap-2">
        ...
        <div className="flex-1 flex items-center justify-end gap-1.5 min-w-0">
          ...
          <button
            ...
            className="hidden lg:inline-flex relative p-2 rounded-xl bg-slate-800/80 hover:bg-slate-700 text-slate-300 hover:text-emerald-400 border border-slate-700/80 transition active:scale-95 shadow-sm shrink-0 items-center justify-center"
            title="重新整理並同步雲端最新資料"
          >
